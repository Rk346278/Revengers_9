    ...
    >
      ...
      >
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
         ...
         <button className="w-full mt-4 text-center px-6 py-4 bg-cyan-600 text-white font-bold rounded-full shadow-lg shadow-cyan-500/30 hover:bg-cyan-500 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-300">
            Reserve Medicine
        </button>
      </div>
      <style>{`
